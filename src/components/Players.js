  ...
  function Players() {
    ...
    const data = useMemo(
        () =>
            ...
            allUsers.filter(u => globalMe === undefined || globalMe === null || u.id !== globalMe.id)
      ...
      const columns = useMemo(
        () => allUsers === null ? [] : [
          columnHelper.accessor("name", {
            header: "Name",
            cell: (props) => <Link to={`/player/${props.row.original.id}`}>{props.getValue()}</Link>,
          }),
          columnHelper.accessor("lastSeen", {
            header: "Activity",
            cell: (props) => <ActivityMarker lastSeen={props.getValue()} size="m" />,
          }),
