...
function GameMove(props) {
  ...
  useEffect(() => {
    ...
    if (focus?.canExplore) {
      // If you are refreshing your game, but there is no new data, exploration won't be fetched, but maybe you are exploring on 2 devices and you would like to see the update here...
