...
export const CONTENT_SECURITY_POLICY = [
  ...
  "img-src 'self' data: blob: https://www.google-analytics.com https://www.googletagmanager.com https://thumbnails.abstractplay.com https://*.s3.us-east-1.amazonaws.com",
