  ...
  return (
    <>
      <div className="container" style={{ paddingBottom: "1em" }}>
        <h1 className="subtitle">Most completed games per week (recent)</h1>
      </div>
      <ReactMarkdown rehypePlugins={[rehypeRaw]} className="content">
        The number of games completed per week over the past three months
        (roughly).
      </ReactMarkdown>
...
export default CompletedRecent;
