...
Offline funnel/CTR rollups (shows, clicks, challenges by surface/tier/reason) are written to a private ops bucket for human or agent review. See [Recommendation analytics](https://docs.abstractplay.com/crons/recommendations-analytics/). The live recommender does **not** read these artifacts; `tuning.json` remains deferred.
...
- [Crons — recommendation analytics](https://docs.abstractplay.com/crons/recommendations-analytics/) — nightly impression funnel rollups (ops S3)
