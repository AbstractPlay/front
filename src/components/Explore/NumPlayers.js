...
function NumPlayers({ toggleStar, openImgModal }) {
  ...
  const data = useMemo(
    ...
    [t, mvTimes, games, globalMe, gameImages]
  );
  ...
  return (
    <>
      <div className="container" style={{ paddingBottom: "1em" }}>
        <h1 className="subtitle">Most players</h1>
      </div>
      <ReactMarkdown rehypePlugins={[rehypeRaw]} className="content">
        The total number of unique players who played that game over the time
        period.
      </ReactMarkdown>
