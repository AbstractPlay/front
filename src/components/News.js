    ...
    return (
        <article>
            ...
            <div className="content">
                ...
                <p>The authoritative and most up-to-date source of Abstract Play news is <a href="https://discord.abstractplay.com" target="blank" rel="noreferer">our Discord server</a>. Please come join us! This list is maintained separately, only includes a subset of the announcements, and may be slightly delayed.</p>
            </div>
