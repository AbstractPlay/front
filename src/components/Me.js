            ...
            <div className="indentedContainer">
              ...
              {over.length === 0 ? (
                ...
                <Fragment>
                  ...
                  <p className="help"><em>To keep the dashboard manageable, games drop off this list 48 hours after the "last seen" date. Click the Clear button to remove it immediately. Visit the Games page to access older completed games.</em></p>
